  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center justify-center md:p-2 gap-10 md:pt-8 pt-5 md:pb-12 pb-12 xl:p-12 xl:gap-20 group">
        <div className="flex flex-col h-[31rem] group-hover:blur-sm hover:!blur-none group-hover:scale-[0.85] hover:!scale-100 cursor-pointer text-center text-white font-semi text-2xl md:text-md md:ml-2 md:mr-2  bg-cyan-600 rounded-3xl md:w-[230px] xl:w-[350px]  shadow-lg shadow-amber-600 hover:shadow-amber-500">
          <img
            src={img1}
            alt=""
          ...
          <div className="flex flex-col items-center justify center space-y-12 h-44 py-3 ">
            ...
            <Link
              to="/reading"
              className="py-3 px-4  inline-flex justifiy-center items-center rounded-3xl border-transparent font-bold bg-amber-500 hover:bg-amber-600"
            >
              Click here
            </Link>
          </div>
