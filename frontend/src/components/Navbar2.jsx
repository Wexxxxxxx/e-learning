...
const Navbar2 = () => {
  return (
    <div>
      <header className="top-0 fixed flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-orange-100 py-5">
        <nav
          className="relative bg-orange-100 max-w-[85rem] flex flex-wrap basis-full items-center w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
          aria-label="Global"
        >
      ...
      >
        <div className="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
          <h3 className="font-bold text-black dark:text-white">MY PROFILE</h3>
          <button
            type="button"
        ...
        <div className="p-4">
          <div className="mb-6">
            <div className="flex justify-between flex-wrap gap-2 w-full">
              <span className="text-gray-700 font-bold">Student Id</span>
            </div>
        ...
        <div className="p-4">
          <div className="mb-6">
            ...
            <p className="text-black">MIDDLE NAME</p>
          </div>
        </div>
        <div className="p-4">
          <div className="mb-6">
        ...
        <div className="p-4">
          <div className="mb-6">
            <div className="flex justify-between flex-wrap gap-2 w-full">
              <span className="text-gray-700 font-bold">My Stars</span>
            </div>
        ...
        <div className="p-4">
          <div className="mb-6">
            ...
            <Link className="text-black font-bold">ABOUT</Link>
          </div>
          <div className="mb-6">
            <div className="flex justify-between flex-wrap gap-2 w-full"></div>
            <Link className="text-black font-bold">MENU</Link>
          </div>
          <div className="mb-6">
            <div className="flex justify-between flex-wrap gap-2 w-full"></div>
            <Link className="text-black font-bold">SIGN OUT</Link>
          </div>
        </div>
      </div>
    </div>
