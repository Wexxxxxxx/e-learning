...
const ActivityContents = () => {
  ...
  return (
    <div className="bg-[url('/background2.png')] h-screen md:h-screen bg-no-repeat bg-cover">
      <Navbar2 />
      <div
      ...
      {/* Card Blog */}
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-[200px] mx-auto">
        {/* Grid */}
