...
const Tropical = () => {
  ...
  return (
    ...
    <div className="m-10 bg-[url('/Tropical.png')] bg-cover bg-no-repeat">
      {/* <FaArrowLeft className="leftBtn" onClick={leftHandle} />
      <FaArrowRight className="rightBtn" onClick={rightHandle} /> */}
      <h1 className="mb-10 text-center font-bold text-amber-300 tracking-widest text-7xl">Tropical Island</h1>
